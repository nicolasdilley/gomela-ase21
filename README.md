...
The information in the spreadsheet are displayed as follow:
  ...
  - Column 2: The result of Gomela on the original program. If Gomela could not parse the program 
    then the program was either modified to meet Gomela limitation.
  - Column 3: Result of GCatch on original program.
  - Column 4: Result of Gomela on massaged version.
  - Column 5: Results of GCatch on massaged version.
  - Column 6: Time taken by Gomela to verify the program
  - Column 7: Whether a send on a closed channel safety error was found by Gomela 
  - Column 8: Whether a close on a closed channel safety error was found by Gomela
  - Column 9: Whether a Waitgroup safety error was found by Gomela
  - Column 10: Whether a Mutex safety error was found by Gomela
  - Column 11: Whether a global deadlock was found by Gomela
  - Column 12: Time taken by GCatch to verify the program 
  - Column 13: Whether a missing unlock safety error was found by GCatch 
  - Column 14: Whether a double lock error was found by GCatch
  - Column 15: Whether a BMOC error was found by GCatch
  - Column 16: Time taken by Godel2 to verify the program 
  - Column 17: Whether the model generated by Godel2 was finite control 
  - Column 18: Whether the model generated by Godel2 had a terminal state 
  - Column 19: Whether the model generated by Godel2 had no cycle
  - Column 20: Whether a global deadlock was found in the model by Godel2
  - Column 21: Whether a partial deadlock was found in the model by Godel2
  - Column 22: Whether a channel safety error was found in the model by Godel2
  - Column 23: Whether a the model generated by Godel2 is free from any data race 
  - Column 24: Whether all messages sent in the model generated by Godel2 are received.
  - Column 25: The result of running Godel2 on the program. (found = did Godel2 found the bug, crashed= Godel2 crashed, missed= false alarm raised by Godel2)

Godel2 has been run only on the massaged version when there was one cause it did not support non-massaged program either.


The main keyword used are: 
  - FP = False positive raised
  - UNS = The program is not supported byu the tool
  - MU = Missing unlock property of GCatch
